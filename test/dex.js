...
contract('Dex', (accounts) => {
  ...
  it('should create market order & match', async () => {
    ...
    const recentTrades = await dex.getRecentTrades(REP);
    ...
    assert(recentTrades[0].price.toString() === "10", "Price mismatch")
    assert(recentTrades[0].trader1 === trader1, "Trader1 mismatch")
    assert(recentTrades[0].trader2 === trader2, "Trader2 mismatch")
    assert(recentTrades[0].amount.toString() === web3.utils.toWei("5"), "Amount mismatch")
  });
